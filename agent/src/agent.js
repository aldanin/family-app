...
exports.FamilyAgent = void 0;
const familyMCPClient_1 = require("./familyMCPClient");
const generalKnowledgeTool_1 = require("./generalKnowledgeTool");
const toolSelector_1 = require("./toolSelector");
class FamilyAgent {
    constructor(mcpServerUrl, openaiApiKey, openaiModel) {
        this.familyClient = new familyMCPClient_1.FamilyMCPClient(mcpServerUrl);
        this.generalTool = new generalKnowledgeTool_1.GeneralKnowledgeTool(openaiApiKey, openaiModel);
        // Gather all available tools
        const allTools = [
            ...this.familyClient.getAvailableTools(),
            ...this.generalTool.getAvailableTools()
        ];
        this.toolSelector = new toolSelector_1.ToolSelector(allTools);
    }
    /**
     * Process a query - this is the main entry point
     */
    async processQuery(query, combineWithContext = false) {
     ...
     */
    async demonstrateToolSelection(queries) {
        console.log('\n' + '█'.repeat(80));
...
exports.FamilyAgent = FamilyAgent;
